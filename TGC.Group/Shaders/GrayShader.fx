...
float4 ps_main(float2 Texcoord: TEXCOORD0, float4 Color : COLOR0) : COLOR0
{
	...
	// Armo escala de grices
	float escalaDeGris = ( fvBaseColor.r + fvBaseColor.g + fvBaseColor.b ) / 3.0f; 
	return float4(escalaDeGris,escalaDeGris,escalaDeGris,fvBaseColor.a);
}
